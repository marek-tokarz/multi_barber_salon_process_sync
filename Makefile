all: KASJER PROCEDURA_KLIENT PROCEDURA_FRYZJER serwer_poczekalnia serwer_kasa proces_klient proces_fryzjer
...
serwer_kasa: serwer_kasa.o operacje_semafor.o
	gcc -o serwer_kasa serwer_kasa.o operacje_semafor.o
